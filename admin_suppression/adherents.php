<html>
	...
	<center><h1>Listes des adherents </h1></center>
	...
	<?php
				...
				echo '<center><table border="1"></center><tr><th>Nom</th><th>Prenom</th><th>Adresse mail</th></th><th>supprimer</th></tr><tr>'; 

					while ($donnees = $reponse->fetch())
					{
						echo '<td>'.$donnees['PRENOM'] . '</td><td>'.$donnees['NOM'].'</td><td>'.$donnees['ADRESSEMAIL'].'</td><td><a href=modtest_a.php?modid='.$donnees['NUM_ADHERENT'].'><img  src="supprimer.ico" alt="supprimer" width="25px" /></a></td>'.'</tr>';
