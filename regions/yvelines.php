<!DOCTYPE html>
	...
	<!--Debut en-tête de page-->
			...
			<h1> <center> Liste de tous les centres equestres des Yvelines </center> </h1>
		...
		<?php
				...
				$reponse = $bdd->query('SELECT * from centre where cpcentre like "78%"');
