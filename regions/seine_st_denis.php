<!DOCTYPE html>
	<html lang="fr">
    <head>
        <title>Centres | Seine-Saint-Denis</title>
	...
	<!--Debut en-tête de page-->
			...
			<h1> <center> Liste de tous les centres equestres de seine st denis </center> </h1>
		...
		<?php
				...
				$reponse = $bdd->query('SELECT * from centre where cpcentre like "93%"');
