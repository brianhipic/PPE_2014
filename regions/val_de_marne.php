<!DOCTYPE html>
	<html lang="fr">
    <head>
        <title>Centres | Val-De-Marne</title>
	...
	<!--Debut en-tête de page-->
			...
			<h1> <center> Liste de tous les centres equestres du val de Marne </center> </h1>
		...
		<?php
				...
				$reponse = $bdd->query('SELECT * from centre where cpcentre like "94%"');
