<!DOCTYPE html>
    ...
    <head>
        <title>Centres | Seine-Et-Marne</title>
	...
	<!--Debut en-tête de page-->
			...
			<h1> <center> Liste de tous les centres equestres de Seine Et Marne </center> </h1>
		...
		<?php
				...
				$reponse = $bdd->query('SELECT * from centre where cpcentre like "77%"');
