<!DOCTYPE html>
	<html lang="fr">
    <head>
        <title>Centres | Hauts-De-Seine</title>
	...
	<!--Debut en-tête de page-->
			...
			<h1> <center> Liste de tous les centres equestres de haut de seine </center> </h1>
		...
		<?php
				...
				$reponse = $bdd->query('SELECT * from centre where cpcentre like "92%"');
